...
#include "music_enhancement_module.h"
...
/*
 * There are three scenarios, in which MUSICEnhancementModule can be loaded by NEST:
 *
...
music_enhancement_module::MUSICEnhancementModule music_enhancement_module_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

music_enhancement_module::MUSICEnhancementModule::MUSICEnhancementModule()
{
#ifdef LINKED_MODULE
...
const std::string
music_enhancement_module::MUSICEnhancementModule::name( void ) const
{
  return std::string( "MUSIC Streaming enhancements" ); // Return name of the module
}

const std::string
music_enhancement_module::MUSICEnhancementModule::commandstring( void ) const
{
  // Instruct the interpreter to load mymodule-init.sli
  return std::string( "(music_enhancement_module-init) run" );
}

//-------------------------------------------------------------------------------------

void
music_enhancement_module::MUSICEnhancementModule::init( SLIInterpreter* i )
{
